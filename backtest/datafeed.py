...
'''
    ...
    - multiplier: 1
'''
def get_historical_stock(ticker: str, **kwargs) -> None:
    ...
    return write_historical_stock_to_csv(resp, timespan)
...
'''
    ...
    ('openinterest', 6)
'''
def write_historical_stock_to_csv(resp, timespan):
...
if __name__ == '__main__':
    ...
    for k, v in args.items():
        if v:
            valid_args[k] = v
    cwd = ''
    get_historical_stock(**valid_args)
